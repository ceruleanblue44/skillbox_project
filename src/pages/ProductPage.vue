        ...
        <div class="item__desc">
          ...
          <div class="item__content">
            ...
            <p>
              ...
              эффективными. Wahoo ELEMNT BOLT GPSсинхронизируется с датчиками по
              ANT+, объединяя полученную с них информацию. Данные отображаются
...
export default {
  ...
  watch: {
    ...
    '$route.params.id': {
      ...
      immediate: true,
      // The following never fires off because we have renderind conditions in the template:
      // if (!this.product) {
